...
.wadah {
  lebar maksimum: 1170 piksel;
  bantalan: 0 15px;
  margin: 0 otomatis;
}

.top-wrapper {
  pengisi: 180 piksel 0 100 piksel 0;
...
tajuk {
  tinggi: 65px;
  lebar: 100%;
  warna latar belakang: rgba(34, 49, 52, 0.9);
  posisi : tetap;
  atas: 0;
  indeks-z: 10;
}
